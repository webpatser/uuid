...
class SqlServerTest extends TestCase
{
     ...
     */
    public function testImportFromSqlServer(): void
    {
     ...
     */
    public function testToSqlServer(): void
    {
     ...
     */
    public function testSqlServerBinary(): void
    {
        $standardUuid = '6B075B82-EC44-11E5-80DC-00155D0ABC54';
        $uuid = Uuid::import($standardUuid);
     ...
     */
    public function testEndianessWithDifferentVersions(): void
    {
        $testUuids = [
     ...
     */
    public function testSqlServerFormatDetection(): void
    {
     ...
     */
    public function testInvalidSqlServerGuid(): void
    {
     ...
     */
    public function testByteReversalPattern(): void
    {
